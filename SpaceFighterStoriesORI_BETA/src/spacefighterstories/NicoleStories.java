 ...
 /*
    ...
    public static void scenario(Player player1) throws InterruptedException {
        ...
        if (x == 0) {
            ...
            SysBackbone.storyContinue();
            System.out.println("Nicole : But someday it wold be boring.");
            SysBackbone.storyContinue();
            ...
            if (storyCheckpoint == 11) {
                ...
                System.out.println(player1.getName() + " : (1. A squat grey building of only 34 stories...) \n"
            ...
            //--End of Scenario
            player1.setRelationship(player1.getRelationship() + relationPoints);
            ...
            //If player isn't able to complete in  time, then...
            System.out.println("Nicole : Too slow boi!"); // relationPoint -2
            System.out.println("");
            ...
            if (player1.getRelationship() > 90) {
                ...
                SysBackbone.storyContinue();
                System.out.println(player1.getName() + " : Choose an action... /n"
                        + "   (1. Charge to the man.) /n"
                        + "   (2. Sneak to the man.) /n"
    ...
    public static void startTimer(int timeLimit) {
