...
public class Endings {
    ...
    public static void credits(Player player1) {
        System.out.println("");
    ...
    public static void endingSelector(Player player1) {
        if (player1.getPeace() >= 50 && player1.getRelationship() >= 50) {
        ...
        } else if (player1.getPeace() >= 50 && player1.getRelationship() < 50) {
            //Ending 2
        ...
        //Ending 3
        if (player1.getPeace() > 0 && player1.getPeace() < 50 && player1.getRelationship() >= 50) {
        ...
        } else if (player1.getPeace() > 0 && player1.getPeace() < 50 && player1.getRelationship() < 50) {
            //Ending 4
