...
PHASE - Step by step upgrades. Do not release unless all listed in a certain phase is finished.
...
- NearDeath : Reciever's health is down to 20
...
PHASE 2 (IF ABLE TO MAKE POPUPS, NOT NESSESARY TO USE NETBEANS TO RUN.)
Multiple enemies (TBDL)

Initialise Scenario 4 (the typing minigame)

Colours....
 */
package maincommand;

import storyline.NicoleStories;
import storyline.Introduction;
...
import static maincommand.SysBackbone.inputString;
import sun.audio.*;
...
//        try {
//            loop = true;
//            music = new FileInputStream(new File("src\\audio\\Shelter - Porter Robinson_ Madeon.wav"));
...
//        }
        ...
        Music song = TinySound.loadMusic(new File("src\\audio\\Shelter - Porter Robinson_ Madeon.wav"));
        ...
        do {
            ...
            if (startChoice.equals("1")) {
                ...
                System.out.println("Version 0.1.2 - Added accuracy and evasion, and enemy stats randomiser (enemies not yet nerfed/set)");
                ...
                if (choice.equals("1")) {
                    ...
                    do {
                        ...
                        if (choice.equals("1")) {
                            ...
                            checkpoint = 2;
                            do {
                                choice = SysBackbone.skillMenu();
                                if (choice.equals("1")) {
                                    SysBackbone.skillBuyOrEquip(1, 0);
                                } else if (choice.equals("2")) {
                                    SysBackbone.skillBuyOrEquip(2, 0);
                                } else if (choice.equals("3")) {
                                    SysBackbone.skillBuyOrEquip(3, 0);
                                } else if (choice.equals("4")) {
                                    SysBackbone.skillBuyOrEquip(4, 0);
                                } else if (choice.equals("5")) {
                                    SysBackbone.skillBuyOrEquip(5, 0);
                                } else if (choice.equals("6")) {
                                    checkpoint = 1;
                                }
                            } while (checkpoint == 2);
    ...
    public static void playMusic() {
        ...
        try {
            BGM = new AudioStream(new FileInputStream(new File("src\\audio\\Shelter - Porter Robinson_ Madeon.wav")));
            MD = BGM.getData();
